...
const BlowMoulding = () => {
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 1 }}>
      ...
      <div className='py-3 px-2 md:px-24'>
        <div className='ml-auto px-16 py-8'>
          <Slider slidesToShow={3} slidesToScroll={3} autoplay autoplaySpeed={3000} arrows dots className="flex flex-wrap -m-4">
            {
              [
                "/products/businesses/extrusion/1.png",
                "/products/businesses/extrusion/2.png",
                "/products/businesses/extrusion/3.png",
                "/products/businesses/extrusion/4.png",
                "/products/businesses/extrusion/5.png",
                "/products/businesses/extrusion/6.png",
                "/products/businesses/extrusion/7.png"
              ].map((a, i) => (
      ...
      <div className='py-3 px-2 md:px-24 mb-12'>
        <div className='ml-auto px-16'>
          <div className='text-black ml-auto flex flex-col gap-8 text-md'>
            ...
            <div className='flex flex-col gap-2 py-6' data-aos-once="true" data-aos="fade-left" data-aos-delay="400">
              ...
              <section data-aos-once="true" data-aos="fade-left" data-aos-delay="100" className="text-gray-600 bg-gray-200 rounded-md body-font">
              ...
              <section data-aos-once="true" data-aos="fade-right" data-aos-delay="100" className="text-gray-600 body-font">
                <div className="container mx-auto flex py-12 md:flex-row flex-col items-center">
